...
const Hero = () => {
  return (
    <div className="mx-5 pb-20 sm:mx-16 lg:mx-32">
      <div className="border-borderColor flex flex-col items-center border sm:flex-row">
        <div className="text-greyMed2 flex justify-center max-sm:py-16 sm:w-1/2">
          <div>
            ...
            <h1 className="font-parta text-3xl leading-relaxed font-normal md:text-5xl">
              Latest Arrivals
            </h1>
        ...
        <img
          src={assets.hero_img}
          alt="hero image"
          className="w-full object-fill sm:w-1/2"
        />
      </div>
    </div>
  );
